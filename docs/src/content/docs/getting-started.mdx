...
<Tabs>
    <TabItem label="React">
    <AllPackageManagers pkg="croct-nanostores @croct/plug @nanostores/react" />
    </TabItem>

    <TabItem label="Vue">
    <AllPackageManagers pkg="croct-nanostores @croct/plug @nanostores/vue" />
    </TabItem>

    <TabItem label="Solid">
    <AllPackageManagers pkg="croct-nanostores @croct/plug @nanostores/solid" />
    </TabItem>

    <TabItem label="Preact">
    <AllPackageManagers pkg="croct-nanostores @croct/plug @nanostores/preact" />
    </TabItem>

    <TabItem label="Svelte">
    <AllPackageManagers pkg="croct-nanostores @croct/plug" />
...
<AllPackageManagers type="dlx" pkg="croct@latest" args="install" />
