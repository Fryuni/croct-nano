...
Install the `croct-nanostores` package along with the connector for your framework:
...
<Tabs>
    ...
    <TabItem label="Vue">
    ```sh
    npm install croct-nanostores @nanostores/vue
    ```
    </TabItem>

    <TabItem label="Solid">
    ```sh
    npm install croct-nanostores @nanostores/solid
    ```
    </TabItem>

    <TabItem label="Preact">
    ```sh
    npm install croct-nanostores @nanostores/preact
    ```
    </TabItem>

    <TabItem label="Svelte">
    ```sh
    npm install croct-nanostores
    ```
...
The `croct` object is the same [`@croct/plug`](https://docs.croct.com/reference/sdk/javascript/api/plug) singleton you may already be familiar with. Importing it from `croct-nanostores` automatically registers the library's internal plugin — no extra setup needed.
